...
<table>
  <tr>
    <td><img src="images/bauman.jpg" alt="Allie Bauman" style="width:60px;height:60px;"></td>
  ...
  <tr>
    <td><img src="images/tais.jpg" alt="Ta&iacute;s de Menezes" style="width:60px;height:60px;"></td>
  ...
  <tr>
    <td><img src="images/gill.jpg" alt="Mackenzie Gill" style="width:60px;height:60px;"></td>
    <td><span style="font-size: 16px; font-weight: bold;">Mackenzie Gill</span></td>
  </tr>
  <tr>
    <td><img src="images/lauren.jpg" alt="Lauren Chenarides" style="width:60px;height:60px;"></td>
