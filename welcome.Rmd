...
<div style="text-align: center; margin: 10px;">
  ...
  <br>
  <a href="https://scholar.google.com/citations?user=KsJSnW4AAAAJ&hl=en" style="font-size: 16px; font-weight: bold;">Allie Bauman</a>
</div>
<div style="text-align: center; margin: 10px;">
  <img src="path\_to\_rebecca\_cleary\_thumbnail.jpg" alt="Brooke Fitzgerald" style="width: 120px; height: 120px; object-fit: cover; border-radius: 50%;">
  <br>
  <span style="font-size: 16px; font-weight: bold;">Brooke Fitzgerald</span>
</div>
<div style="text-align: center; margin: 10px;">
  <img src="path\_to\_rebecca\_cleary\_thumbnail.jpg" alt="Rebecca Cleary" style="width: 120px; height: 120px; object-fit: cover; border-radius: 50%;">
  <br>
  <a href="https://scholar.google.com/citations?user=5epEG0wAAAAJ&hl=en" style="font-size: 16px; font-weight: bold;">Rebecca Cleary</a>
</div>
<div style="text-align: center; margin: 10px;">
  <img src="images/tais.jpg" alt="Ta&iacute;s de Menezes" style="width: 120px; height: 120px; object-fit: cover; border-radius: 50%;">
  <br>
  <a href="https://scholar.google.com/citations?user=9xUKUroAAAAJ&hl=en&oi=ao" style="font-size: 16px; font-weight: bold;">Ta&iacute;s de Menezes</a>
</div>
<div style="text-align: center; margin: 10px;">
  <img src="path\_to\_alessandro\_bonanno\_thumbnail.jpg" alt="Alessandro Bonanno" style="width: 120px; height: 120px; object-fit: cover; border-radius: 50%;">
  <br>
  <a href="https://scholar.google.com/citations?user=TYjq1G4AAAAJ&hl=en" style="font-size: 16px; font-weight: bold;">Alessandro Bonanno</a>
</div>
<div style="text-align: center; margin: 10px;">
  <img src="images/gill.jpg" alt="Mackenzie Gill" style="width: 120px; height: 120px; object-fit: cover; border-radius: 50%;">
  <br>
  <a href="https://www.linkedin.com/in/mackenzie-gill/" style="font-size: 16px; font-weight: bold;">Mackenzie Gill</a>
</div>
<div style="text-align: center; margin: 10px;">
  <img src="images/lauren.jpg" alt="Lauren Chenarides" style="width: 120px; height: 120px; object-fit: cover; border-radius: 50%;">
  <br>
  <a href="https://www.linkedin.com/in/laurenchenarides/" style="font-size: 16px; font-weight: bold;">Lauren Chenarides</a>
</div>
<div style="text-align: center; margin: 10px;">
  <img src="path\_to\_rebecca\_cleary\_thumbnail.jpg" alt="Sione Ikeme" style="width: 120px; height: 120px; object-fit: cover; border-radius: 50%;">
  <br>
  <span style="font-size: 16px; font-weight: bold;">Sione Ikeme</span>
</div>
<div style="text-align: center; margin: 10px;">
  <img src="images/mayla.jpg" alt="Mayla Boguslav" style="width: 120px; height: 120px; object-fit: cover; border-radius: 50%;">
  <br>
  <a href="https://www.linkedin.com/in/mayla-boguslav-phd-30402239/" style="font-size: 16px; font-weight: bold;">Mayla Boguslav</a>
</div>
</div>
