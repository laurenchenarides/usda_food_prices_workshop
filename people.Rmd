...
htmltools::HTML('
<div style="display: flex; align-items: center;">
  <strong style="margin-right: 10px;">Abby Okrent</strong>
  <img src="images/Abby_Okrent.jpg" alt="Abby Okrent" style="width: 120px; height: 120px; object-fit: cover; border-radius: 50%;">
</div>
')
